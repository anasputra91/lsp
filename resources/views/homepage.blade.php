...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('/import/assets/css/owl.carousel.min.css') }}" rel="stylesheet">

        <link href="{{ asset('/import/assets/css/owl.theme.default.min.css') }}" rel="stylesheet">

        <link href="{{ asset('/import/assets/css/templatemo-medic-care.css') }}" rel="stylesheet">
<!--
                            ...
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{ asset('/import/assets/images/slider/portrait-successful-mid-adult-doctor-with-crossed-arms.jpg') }}" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item">
                                        <img src="{{ asset('/import/assets/images/slider/young-asian-female-dentist-white-coat-posing-clinic-equipment.jpg') }}" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item">
                                        <img src="{{ asset('/import/assets/images/slider/doctor-s-hand-holding-stethoscope-closeup.jpg') }}" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-6 ps-0">
                            <img src="{{ asset('/import/assets/images/gallery/medium-shot-man-getting-vaccine.jpg') }}" class="img-fluid galleryImage" alt="get a vaccine" title="get a vaccine for yourself">
                        </div>

                        <div class="col-lg-6 col-6 pe-0">
                            <img src="{{ asset('/import/assets/images/gallery/female-doctor-with-presenting-hand-gesture.jpg') }}" class="img-fluid galleryImage" alt="wear a mask" title="wear a mask to protect yourself">
                        </div>
