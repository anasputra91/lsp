...
@error('tgl_beli') is-invalid @enderror" id="tgl_beli" placeholder="Tanggal Beli" name="tgl_beli" value="{{date('Y-d-m H:i:s') ?? old('tgl_beli')}}">
...
@error('nama_distributor') is-invalid @enderror" placeholder="Nama Distributor" id="nama_distributor" name="nama_distributor" value="{{old('nama_distributor')}}" arialabel="Alamat" aria-describedby="cari" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control
@error('name') is-invalid @enderror" placeholder="Nama User" id="name" name="name" value="{{Auth::user()->name}}" arialabel="Email" aria-describedby="cari" readonly>
